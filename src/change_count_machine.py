...
def compute_loop(money_left,denom_list,denom_counts,total_items):
    ...
    while (money_left > 0):
        ...
        loop_val += 1
    return total_items, denom_counts #Returning the total items count along with how much of each denomination to compute_change
...
def compute_change(money):
    ...
    return total_items, denom_counts #Returning the total items count along with how much of each denomination to the requester
